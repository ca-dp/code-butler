...
`
    ...
    const result = prompt.getCodeReviewSystemPrompt('en')

    expect(result).toEqual(expectedPrompt)
  })
})

describe('getCodeReviewSystemPromptJa', () => {
  // Set required environment variables
  process.env.OPENAI_API_KEY = 'mocked-api-key'
  it('should return the correct system prompt', () => {
    const expectedPrompt = `
...
`
    const result = prompt.getCodeReviewSystemPrompt('ja')
...
`
    ...
    const result = prompt.getChatSystemPrompt('en')

    expect(result).toEqual(expectedPrompt)
  })
})

describe('getChatSystemPromptJa', () => {
  it('should return the correct system prompt', () => {
    const expectedPrompt = `
...
`
    const result = prompt.getChatSystemPrompt('ja')
